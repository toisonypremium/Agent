...
- [x] Viết ADR phân tách tài sản OKX và vốn chiến lược.
- [ ] Xác nhận API key OKX read-only riêng, chỉ Spot.
- [x] Source map client/live integration hiện có hoặc tạo client hẹp.
- [x] Viết tests red cho client và artifact validation.
- [x] Tạo observer tài sản OKX chỉ đọc.
