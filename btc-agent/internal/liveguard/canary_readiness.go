...
// ValidateCanaryReadinessReport enforces a fresh, complete READY verdict at the
// production boundary. A report is evidence only; it never grants authority by
// itself and must agree with the current runtime safety facts.
