...
func (s *Service) DCAStrategy() DCAStrategy {
	base := []string{"Chưa có thesis được phê duyệt và cấp vốn riêng cho coin này", "Operator halt đang bật", "Chưa đủ evidence để cấp quyền auto-live"}
	return DCAStrategy{Stage: "HALTED_SHADOW", Mechanism: "Limit/post-only · Ba lớp 25% / 35% / 40%", ExecutionAuthority: false,
		...
		Candidates: []DCACandidate{{"ETH", "danh_sach_dca", "trung_binh", "", "0", "Nền tảng smart-contract và thanh khoản core", append([]string{}, base...)}, {"LINK", "danh_sach_dca", "trung_binh_cao", "", "0", "Hạ tầng oracle và CCIP", append([]string{}, base...)}, {"VIRTUAL", "danh_sach_dca", "cao", "", "0", "Narrative giao thức AI-agent", append([]string{}, base...)}}, GlobalBlockers: base}
}
