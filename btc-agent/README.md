...
- Production chạy `live-auto` với real execution được bật. Mỗi lệnh vẫn fail-closed qua market authority, audit/proof, final assertion, risk, reconcile, liquidity và notional caps; không gate nào được nới.
